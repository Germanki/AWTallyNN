...
png(filename = paste0(output_dir, "filtering_summary.png"), width = 800, height = 600)
...
png(filename = paste0(output_dir, "variant_distribution.png"), width = 800, height = 600)
plotDistributions(se, plotType = "density", pseudocount = 1)
dev.off()

# Plot the total counts per variant and save as PNG
png(filename = paste0(output_dir, "variant_totals.png"), width = 800, height = 600)
plotTotals(se)
dev.off()
